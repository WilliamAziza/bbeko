    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <Image src="/next.svg" alt="BEK Logo" width={32} height={32} className="dark:invert h-auto w-auto" priority />
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">BEK</h1>
            </div>
      ...
      <section className="min-h-[70vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 bg-[url('/images/students.jpg')] bg-cover bg-center relative opacity-80 before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-b before:from-black/30 before:to-black/70 before:z-[-1]">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black bg-gradient-to-br from-blue-600 via-white to-emerald-500 bg-clip-text text-transparent mb-8 leading-tight">
            Best Brain Examinations
            <br />
            <span className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-gray-200">KOnsortium</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="#services" className="px-10 py-5 border-2 border-emerald-500/50 bg-transparent text-emerald-400 font-semibold text-lg rounded-2xl hover:bg-emerald-500/10 hover:border-emerald-500 transition-all duration-300">
              View Services
            </a>
          </div>
        </div>
      ...
      <section id="services" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Comprehensive Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service) => (
              <div key={service.title} className="group bg-white p-10 rounded-3xl border border-gray-200 hover:shadow-2xl hover:-translate-y-4 hover:border-emerald-400 transition-all duration-500 overflow-hidden shadow-lg">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center group-hover:text-emerald-600 transition-colors">{service.title}</h3>
                <p className="text-gray-600 text-center leading-relaxed group-hover:text-gray-900">{service.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-8 leading-tight">Excellence in Neurology</h2>
      ...
      {/* Contact */}
      <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-emerald-50/50">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Ready for Precision Diagnosis?</h2>
      ...
      {/* Footer */}
      <footer className="bg-white/50 border-t border-gray-200 py-12 px-4 sm:px-6 lg:px-8 backdrop-blur-md">
